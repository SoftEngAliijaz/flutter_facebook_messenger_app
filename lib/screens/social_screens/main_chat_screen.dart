...
/// Main chat screen widget for displaying chat-related information.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  prefixIcon:
                      Icon(Icons.search, color: Colors.grey.withOpacity(1)),
                ...
                children: [
                  badges.Badge(
                    badgeStyle: badges.BadgeStyle(
                      elevation: 50,
                      badgeColor:
                          Colors.white, // Set badge background color to white
                    ),
                    badgeContent: Text(
                      "+",
                  ...
                  (index) => Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(AppUtils.randomPeopleNames[index])
                      ],
                    ),
                  ),
                ),
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      val == 1 ? Colors.white : Colors.grey.withOpacity(0.08),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      val == 1 ? Colors.grey.withOpacity(0.08) : Colors.white,
                  borderRadius: BorderRadius.circular(15.0),
                ),
                child: Center(
                  child: Text(
        ...
        // Chat messages or channels list based on selected tab
        Builder(
          builder: (context) {
            if (val == 0) {
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing: Text('${DateTime.now()}'.substring(0, 10)),
                      onTap: () {
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTile(
                            ...
                            title: Text("ICC-International Cricket Council"),
                            subtitle: Text(
                              'Lorem ipsum dolor sit amet.',
                              overflow: TextOverflow.ellipsis,
                            ),
